...
public class ApprovalprocessTestContainer extends TestContainer {

    public ApprovalprocessTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/approvalprocess/app.properties",
    ...
    public static class Common extends ApprovalprocessTestContainer {

        public static final ApprovalprocessTestContainer.Common INSTANCE = new ApprovalprocessTestContainer.Common();
