...
public class StockTestContainer extends TestContainer {

    public StockTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/stock/app.properties",
    ...
    public static class Common extends StockTestContainer {

        public static final StockTestContainer.Common INSTANCE = new StockTestContainer.Common();
